...
function ResetForm() {
    ...
    if (!token) {
        return (
            <div className="text-center py-8">
                ...
                <Link href="/partner/forgot-password" className="text-orange-600 font-semibold">Request a new link →</Link>
            </div>
        );
    }
    ...
    return success ? (
        <div className="text-center py-4">
            ...
            <Link href="/partner/login" className="px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-bold shadow-lg inline-block">
                Go to Login →
            </Link>
        </div>
    ) : (
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
                ...
                <div className="relative">
                    <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)}
                        className="input-modern w-full px-4 py-3 pr-16 rounded-xl bg-white border-2 border-gray-200 focus:outline-none text-gray-900"
            ...
            <button type="submit" disabled={loading}
                className="btn-modern w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-3.5 rounded-xl font-bold disabled:opacity-50 shadow-lg shadow-orange-200/50">
        ...
        <div className="min-h-screen gradient-white flex items-center justify-center px-4 py-12">
            <div className="w-full max-w-md">
                <div className="text-center mb-8 animate-fade-in">
                    ...
                    <h1 className="text-3xl font-bold mb-1"><span className="text-gradient">New Password</span></h1>
                    <p className="text-gray-500">Create a new password for your partner account</p>
                </div>
